...
class Admin::BuildingsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Building: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Building: create, read, update, custom_action_for_an_item
  #
