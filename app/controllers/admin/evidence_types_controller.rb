...
class Admin::EvidenceTypesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     EvidenceType: create, read, update, destroy, custom_action
  #
  #   editor:
  #     EvidenceType: create, read, update, custom_action_for_an_item
  #
